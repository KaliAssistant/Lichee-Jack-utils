/*
 * shmled.c - Shared memory RGB LED writer for Lichee-Jack Kernel space driver
 *
 ...
 *
 * This file is part of the Lichee-Jack project and is licensed under the GNU
 * General Public License v3.0 or later.
 *
 * shmled is a lightweight utility daemon that writes RGB color data
 * into shared memory to control WS2812 RGB LEDs via the Lichee-Jack WS2812B-GPIO driver.
 ...
 *
 * Project GitHub: https://github.com/KaliAssistant/Lichee-Jack
 *                 https://github.com/KaliAssistant/Lichee-Jack-utils
 */
...
static void usage(const char *prog_name) {
    if (!prog_name) return;
    fprintf(stderr, "shmLED - Shared memory RGB LED writer for Lichee-Jack WS2812-GPIO Driver\n\n");
    ...
    fprintf(stderr, "Github: https://github.com/KaliAssistant/Lichee-Jack-utils.git\n");
    return;
}
